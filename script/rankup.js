...
let random = Math.floor(Math.random() * 7) + 1;
    ...
    if (existsSync(__dirname + "/noprefix/rankup.gif")) mkdirSync(__dirname + "/noprefix/rankup.gif", { recursive: true });
    if (existsSync(__dirname + `/noprefix/rankup.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/noprefix/rankup.gif`), mentions: [{ tag: name, id: senderID }] };
